...
function blowCandle() {
  ...
  if (cake) {
    cake.classList.add("fade-out-slow");
    setTimeout(() => {
      nextStep(); // lanjut ke step berikutnya
    }, 3000);
  } else {
    console.error("Elemen #birthdayCake tidak ditemukan.");
  }
}
...
function typeMessage() {
    const messages = [
        `hai ${userName},`,
        "di hari spesial ini aku cuman pengen kamu tau...",
        "kamu itu orang yang aku sayang bangett asli deh ga bohong.",
        "aku cuman mau bilang semoga apa yang kamu inginkan dari dulu atau kedepannya bisa kesampaian ya sayang.",
        "aku berharap kamu selalu bahagia, entah itu sama aku ataua orang lain ( ya kalo bisa si sama aku juga :D )",
        "pokoknya doa yang baik baik selalu terjadi ke kamu ya sayang",
        "kalo dari aku si cuman mau kamu tetep jadi diri kamu sendiri di depan aku tetep sayang aku tetep clingy ke aku tetep dirty mind ke aku pokoknya tetep jadi kamu yang sekarang ya sayang",
        "maaf ya sayang kalo ini jelek hehehehe aku juga baru belajar soalnya aku bingung masa ngucapin nya biasa doang kaya bukan aku banget , mau aku samperin terus aku kasih surprise kan ga mungkin kayaknya ya sayang ",
        "ohh iya sayang maaf ya aku beberapa hari ini bohong sebenernya aku bilang tidur itu ga tidur aku ngerjain ini soalnya gaada waktu banget aku kerja , pulang kerja sama kamu kalo aku ngerjain pas lagi sama kamu aku nya gamau karena waktu kita ke ambil ya jadii aku ngerjain ini pas aku bilang bobo hehehe maaf sayanggg asli deh karena kepepet aja",
        "udah si itu aja selamat ya umur kamu sekarang 19 th yahh kita jadi beda 1 tahun lagii masa cuman 10 hari doang beda 2 tahun HAHAHAHA.",
        "pokoknya i love you sayang akuuu.",
        "Happy Birthday, my love my favorite person! ❤"
    ];
...
function setCountdown() {
  const targetDate = new Date("2025-07-10T00:00:00+07:00");
  ...
  function updateCountdown() {
    ...
    if (diff <= 0) {
      console.log("🎯 Waktu habis: menyembunyikan countdown & menampilkan konten.");
